        ...
        while(justUnderWater.Count() != 0){
                 ...
                 tile.GetCoordinates()[1] == terrainTilesInfo.GetLength(1) - 1)
            {
                ...
                foreach(Vector3Int neighbour in neighbours){
                    if(terrainTilesInfo[neighbour.x,neighbour.y].GetIsFlooded() && terrainTilesInfo[neighbour.x,neighbour.y].GetHeight() > (actualLayer - 1) ){
...
>>>>>>> 0da171d37c5d39d90858b25a292abf5154e1cb96
